...
var BankService = /** @class */ (function () {
    ...
    BankService.prototype.getBankList = function (city) {
        var myCity = city.toUpperCase();
...
var BanksComponent = /** @class */ (function () {
    ...
    Object.defineProperty(BanksComponent.prototype, "allbanks", {
        get: function () {
    ...
    BanksComponent.prototype.loadDisplay = function () {
        debugger;
    ...
    BanksComponent.prototype.onSelectCity = function () {
        console.log(this.city);
        this.allbanks = this.bankService.getBankList(this.city);
        console.log(this.allbanks);
    };
    BanksComponent.ctorParameters = function () { return [
